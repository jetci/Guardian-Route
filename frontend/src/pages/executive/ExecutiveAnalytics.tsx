...
export default function ExecutiveAnalytics() {
  ...
  // Mock data
  const detailedData = [
    { id: 'INC-001', type: 'อุทกภัย', date: '2025-11-12', severity: 'สูง', area: 'บ้านหนองบัว', responseTime: '2.5 ชม.' },
    { id: 'INC-002', type: 'ดินถล่ม', date: '2025-11-11', severity: 'สูง', area: 'บ้านเขาใหญ่', responseTime: '3.2 ชม.' },
    { id: 'INC-003', type: 'วาตภัย', date: '2025-11-10', severity: 'ปานกลาง', area: 'บ้านป่าไม้', responseTime: '1.8 ชม.' },
    { id: 'INC-004', type: 'อุทกภัย', date: '2025-11-09', severity: 'ต่ำ', area: 'บ้านดอยสูง', responseTime: '2.1 ชม.' },
    { id: 'INC-005', type: 'ไฟป่า', date: '2025-11-08', severity: 'สูง', area: 'บ้านแม่ริม', responseTime: '4.5 ชม.' },
  ];
  ...
  const areaComparison = [
    { area: 'บ้านหนองบัว', avgTime: 2.5, incidents: 8 },
    { area: 'บ้านเขาใหญ่', avgTime: 3.2, incidents: 5 },
    { area: 'บ้านป่าไม้', avgTime: 1.8, incidents: 6 },
    { area: 'บ้านดอยสูง', avgTime: 2.1, incidents: 4 },
    { area: 'บ้านแม่ริม', avgTime: 4.5, incidents: 3 },
  ];
