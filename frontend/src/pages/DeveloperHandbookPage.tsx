          ...
          <div className="nav-sticky">
            ...
            <ul>
              ...
              <li className={activeSection === 'innovation' ? 'active' : ''}>
                <button onClick={() => scrollToSection('innovation')}>
                  3. นวัตกรรมสำหรับหน่วยงานราชการ
                </button>
              </li>
              <li className={activeSection === 'structure' ? 'active' : ''}>
                <button onClick={() => scrollToSection('structure')}>
                  4. โครงสร้างโปรเจกต์
                </button>
              </li>
              ...
              <li className={activeSection === 'state-management' ? 'active' : ''}>
                <button onClick={() => scrollToSection('state-management')}>
                  6. การจัดการ State
                </button>
              </li>
              ...
              <li className={activeSection === 'coding-practice' ? 'active' : ''}>
                <button onClick={() => scrollToSection('coding-practice')}>
                  8. แนวปฏิบัติการเขียนโค้ด
                </button>
              </li>
              <li className={activeSection === 'api-design' ? 'active' : ''}>
                <button onClick={() => scrollToSection('api-design')}>
                  9. การจัดการข้อมูลและ API
                </button>
              </li>
              <li className={activeSection === 'testing' ? 'active' : ''}>
                <button onClick={() => scrollToSection('testing')}>
                  10. การทดสอบและประกันคุณภาพ
                </button>
              </li>
              <li className={activeSection === 'deployment' ? 'active' : ''}>
                <button onClick={() => scrollToSection('deployment')}>
                  11. การติดตั้งและ Deployment
                </button>
              </li>
              <li className={activeSection === 'maintenance' ? 'active' : ''}>
                <button onClick={() => scrollToSection('maintenance')}>
                  12. การดูแลรักษาและอัปเดต
                </button>
              </li>
...
└── docs/                     # Documentation`}
          ...
          <section id="implementation" className="handbook-section">
            ...
            <div className="content-card">
              <h3>📍 Multi-point GPS Pattern</h3>
              <p>มาตรฐานการเก็บพิกัด GPS สำหรับเหตุการณ์ที่มีจุดเกิดเหตุหลายจุด:</p>
              <ul>
                <li><strong>Frontend Logic:</strong>
                  <ul>
                    <li>อนุญาตให้ผู้ใช้ปักหมุดได้หลายจุดบนแผนที่ (Leaflet)</li>
                    <li>เก็บรวบรวมทุกจุดที่วาด (Markers) จาก <code>drawnItems</code></li>
                    <li>ใช้พิกัดล่าสุดเป็น <code>gpsLocation</code> หลัก</li>
                  </ul>
                </li>
                <li><strong>Data Structure:</strong>
                  <ul>
                    <li>ส่งข้อมูลจุดทั้งหมดผ่าน <code>additionalData.markers</code> (สำหรับ Survey)</li>
                    <li>หรือแนบท้าย <code>description</code> (สำหรับ Incident Report)</li>
                  </ul>
                </li>
                <li><strong>UX Requirement:</strong> ต้องแสดงจำนวนจุดทั้งหมดให้ผู้ใช้ทราบก่อนยืนยัน</li>
              </ul>
            </div>

            <div className="content-card">
              <h3>🎯 Incident Assignment Workflow</h3>
              <p>กระบวนการมอบหมายงานจากหัวหน้างาน (Supervisor) ไปยังเจ้าหน้าที่ภาคสนาม (Field Officer):</p>
              <ul>
                <li><strong>Step 1 - Create Incident:</strong>
                  <ul>
                    <li>เจ้าหน้าที่ภาคสนามสร้างรายงานเหตุการณ์ผ่าน <code>/create-incident</code></li>
                    <li>กรอกข้อมูล: ชื่อเหตุการณ์, ประเภทภัย, ระดับความสำคัญ, พิกัด GPS, พื้นที่ได้รับผลกระทบ</li>
                    <li>ระบบนำทางไปหน้า Survey Review เพื่อตรวจสอบข้อมูล</li>
                    <li>หลังยืนยัน ระบบบันทึกเหตุการณ์ด้วยสถานะ <code>PENDING</code></li>
                  </ul>
                </li>
                <li><strong>Step 2 - Supervisor Review:</strong>
                  <ul>
                    <li>หัวหน้างานเข้าหน้า "จัดการเหตุการณ์" (<code>/manage-incidents</code>)</li>
                    <li>เหตุการณ์ใหม่จะปรากฏในแท็บ "ใหม่" (PENDING status)</li>
                    <li>ระบบดึงข้อมูลจาก <code>incidentsApi.getAll()</code> แบบ real-time</li>
                    <li>หัวหน้างานสามารถกรองตามสถานะ, ระดับความสำคัญ, และหมู่บ้าน</li>
                  </ul>
                </li>
                <li><strong>Step 3 - Assign to Field Officer:</strong>
                  <ul>
                    <li>คลิกปุ่ม "มอบหมายงาน" เพื่อเปิด <code>AssignIncidentModal</code></li>
                    <li>Modal ดึงรายชื่อเจ้าหน้าที่จาก <code>usersApi.getFieldOfficers()</code></li>
                    <li>เลือกเจ้าหน้าที่และเพิ่มหมายเหตุ (ถ้ามี)</li>
                    <li>ระบบเรียก <code>incidentsApi.assign(incidentId, fieldOfficerId, notes)</code></li>
                    <li>Backend สร้าง Task และเปลี่ยนสถานะเหตุการณ์เป็น <code>IN_PROGRESS</code></li>
                  </ul>
                </li>
                <li><strong>Step 4 - Field Officer Receives Task:</strong>
                  <ul>
                    <li>เจ้าหน้าที่ที่ได้รับมอบหมายเข้าหน้า "งานของฉัน" (<code>/tasks/my-tasks</code>)</li>
                    <li>งานปรากฏในแท็บ "รอดำเนินการ" (PENDING task status)</li>
                    <li>คลิก "รับงาน" เพื่อเปลี่ยนสถานะเป็น <code>IN_PROGRESS</code></li>
                    <li>เจ้าหน้าที่สามารถเริ่มทำงานตามที่ได้รับมอบหมาย</li>
                  </ul>
                </li>
              </ul>
              <p><strong>API Endpoints ที่เกี่ยวข้อง:</strong></p>
              <ul>
                <li><code>POST /incidents</code> - สร้างเหตุการณ์ใหม่</li>
                <li><code>GET /incidents</code> - ดึงรายการเหตุการณ์ทั้งหมด (with filters)</li>
                <li><code>PATCH /incidents/:id/assign</code> - มอบหมายเหตุการณ์ให้เจ้าหน้าที่</li>
                <li><code>GET /users?role=FIELD_OFFICER</code> - ดึงรายชื่อเจ้าหน้าที่ภาคสนาม</li>
                <li><code>GET /tasks/my-tasks</code> - ดึงงานของเจ้าหน้าที่ที่ login อยู่</li>
                <li><code>PATCH /tasks/:id/status</code> - อัปเดตสถานะงาน</li>
              </ul>
            </div>
          ...
          <section className="handbook-footer">
            ...
            <div className="footer-links">
              ...
              <div className="link-group">
                ...
                <ul>
                  <li><strong>ผู้พัฒนา:</strong> นายเจษฎา มูลมาวัน</li>
                  <li><strong>ตำแหน่ง:</strong> ผู้ช่วยนักวิชาการคอมพิวเตอร์</li>
                  <li><strong>หน่วยงาน:</strong> องค์การบริหารส่วนตำบลเวียง ตำบลเวียง อำเภอฝาง จังหวัดเชียงใหม่</li>
                  <li><strong>Email:</strong> <a href="mailto:intelman26@gmail.com">intelman26@gmail.com</a></li>
            ...
            <div className="copyright">
              ...
              <p>พัฒนาโดย นายเจษฎา มูลมาวัน | องค์การบริหารส่วนตำบลเวียง อำเภอฝาง จังหวัดเชียงใหม่</p>
              <p>Licensed under MIT License | Made with ❤️ for Tambon Wiang</p>
            </div>
          </section>
        </main>
      </div>
